...
class OpenedArtistPage extends StatelessWidget {
  final ArtistGetData art;
  final Result r;
  OpenedArtistPage({super.key, required this.art, required this.r});
        ...
        slivers: [
            ...
            bottom: PreferredSize(
              ...
              child: Transform.translate(
                ...
                child: GestureDetector(
                  onTap: () {
                    Get.put(AudioController()).setMusicList(art.data!.songs!);
                  },
                  child: Container(
          ...
          SliverList(
            delegate: SliverChildListDelegate(
              [
                SizedBox(height: 30),
                for (int i = 0; i < art.data!.songs!.length; i++)
                  Builder(builder: (context) {
                    Result r = Result.fromJson(art.data!.songs![i].toJson());
